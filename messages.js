...
function message(message, values) {
  ...
  for (var i = 0; i < values.length; i++) {
    newMessage = newMessage.replace("%%", values[i]);
  }
...
const messages = {
  ...
  "Recommend a friend_message":
    "Copy/paste a person's @username, e.g. @durov or durov. If a person only having phone number send us his contact.",
  ...
  "Recommend a friend_recommender_recommendee_not_existing_forward_message":
    "Hey there! I've just recommended you on @Minqbot. It's a database of people your contacts trust and recommend. Join @Minqbot, recommend people you trust, and discover people they trust.\nMaybe recommend me back? :)",
