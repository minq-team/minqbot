...
const messages = {
	...
	phone_required: "You don't have a @username on Telegram. It means that we need your phone number to form your connections on Minqbot.\n\nPlease share your contact number with us. We won't share it with anyone – we'll only use it to form your network", // !!!
	phone_required_keyboard: [[{ text: "Share my phone number", request_contact: true }]], // !!!
	...
	"Recommend a friend_keyboard": [["This person has only a phone number on Telegram"], [back]], // !!!
	...
	"Recommend a friend_message_request_number": "Copy/paste a person's phone number.\nIt should start with a country code, e.g. +1234556 (not 234556)", // !!!
	"Recommend a friend_message_wrong_number": "It doesn't look like a phone number :) Try again.", // !!!
	...
	"Recommend a friend_recommender_recommendee_not_existing_forward_message": "Hey there! I've just recommended you on @Minqbot. It's a database of people your contacts trust and recommend. Join @Minqbot, recommend people you trust, and discover great people they trust.\nMaybe recommend me back? :)",
	"Recommend a friend_recommender_recommendee_not_existing_by_phone": "Nice! You've recommended %%. Unfortunately, %% is not on @Minqbot yet, so %% has not recommended anyone and there's no one to add to \"Explore your network\".\nChange it: send a link to @Minqbot to %% so that they'll recommend people they trust and you'll grow your network.\nE.g. you can use this message to copy:", // !!!
	"Recommend a friend_recommender_recommendee_not_existing_forward_message_by_phone": "Hey there! I've just recommended you on @Minqbot. It's a database of people your contacts trust and recommend. Join @Minqbot, recommend people you trust, and discover great people they trust.\nMaybe recommend me back? :)", // !!!
